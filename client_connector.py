#TODO: just connect to exposed listner client
import socket
import threading
import time
import sys
...
#not used anymore since this is set connector client
...
rendezvous_ip = input('Enter Rendezvous server IP. (Should be Host Routers Public IP)\n> ')
